...
<?php
include ("sistema/conexiones/conexion1.php");
    $Nombre="";
    $Apellido="";
    $NumDocumento="";
    $Celular="";
                ...
                <div class="col-lg-6">
                        ...
                        <div class="contact-form">
                            <form class=""   action="controladores/DatosTurnos.php" method="Post" >
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">    
                                    <input type="text" class="form-control" id="ndocumento" value="<?= $Nombre ?>" name="nombre" placeholder="Nombre" required="">
                                    </div>

                                    <div class="col-lg-6">    
                                    <input type="text" class="form-control" id="ndocumento" value="<?= $Apellido ?>" name="apellido" placeholder="Apellido" required="">
                                    </div>

                                    <div class="col-lg-6">
                                    <input type="text" class="form-control" id="ndocumento" value="<?= $NumDocumento ?>" name="ndocumento" placeholder="Documento" required="">
                                    </div>

                                    <div class="col-lg-6">
                                    <input type="text" class="form-control" id="ndocumento" value="<?= $Celular ?>" name="celular" placeholder="Celular" required="">
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                    <input type="text" class="form-control" id="ndocumento" value="<?= $Asunto ?>" name="asunto" placeholder="Asunto" required="">
                                    </div>

                                     <div class="col-lg-12">
                                    <textarea class="form-control" id="ndocumento" value="<?= $Mensaje ?>" name="mensaje" placeholder="Mensaje" required=""></textarea>
                                    </div>
                    ...
                    <div class="container text-center" >
                        <div class="botonesAccion"><?php
                            ...
                            &nbsp;&nbsp;
                            <div class="btn-group">
                                <button type="button" class="au-btn au-btn-icon au-btn--blue" onclick="window.location.href = 'inicio.php';"></button> 
                            </div>  
                        </div>
                    </div>
